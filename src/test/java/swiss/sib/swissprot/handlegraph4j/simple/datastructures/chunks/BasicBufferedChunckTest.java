 ...
 */
public class BasicBufferedChunckTest {
    ...
    public BasicBufferedChunckTest() {
    }
    ...
    public void testIterator() {
        int length = 1000;
        BasicChunk<long[]> basicChunk = createBasicChunk(kva, gk, gv, comp, length);
        var cc = new BasicBufferedChunk<long[]>(basicChunk);
        int i = 0;
    ...
    public void testHasKey() {
        int length = 1000;
        BasicBufferedChunk<long[]> cc = createInstance(length);
    ...
    private BasicBufferedChunk<long[]> createInstance(int length) {
        BasicChunk<long[]> basicChunk = createBasicChunk(kva, gk, gv, comp, length);
        var cc = new BasicBufferedChunk<long[]>(basicChunk);
        return cc;
    }
