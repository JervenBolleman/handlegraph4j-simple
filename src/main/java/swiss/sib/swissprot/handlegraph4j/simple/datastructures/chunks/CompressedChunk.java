...
public class CompressedChunk<T> implements Chunk<T> {
	...
	public CompressedChunk(BasicChunk<T> from, LongLongToObj<T> reconstructor, ToLong<T> getKey, ToLong<T> getValue) {
		this.size = from.size;
	...
	public static <T> boolean canCompress(BasicChunk<T> c, ToLong<T> getKey, ToLong<T> getValue) {
